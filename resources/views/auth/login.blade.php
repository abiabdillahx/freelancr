            ...
            <section class="auth-panel auth-border relative overflow-hidden rounded-[36px] border border-[#2A2A2A] bg-[#171717] p-6 sm:p-8 lg:p-10">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('register') }}" class="auth-outline soft-focus rounded-2xl border border-[#F7931E]/60 bg-[#111111] px-4 py-2 text-sm font-semibold text-[#F05A28] transition hover:bg-[#1f1f1f]">
                            Daftar
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-14 flex flex-col gap-8 lg:mt-20">
                    <div class="max-w-3xl">
                        ...
                        <h1 class="text-5xl font-semibold leading-[1.04] tracking-normal text-[#F05A28] sm:text-6xl lg:text-7xl">
                            Kelola order, chat, dan progress dalam satu tempat.
                        </h1>
                        <p class="auth-muted mt-6 max-w-2xl text-base leading-7 text-[#E5E7EB] sm:text-lg">
                            Masuk untuk lanjut ke dashboard kerja kamu dan kembali ke aktivitas yang lagi jalan.
                        </p>
                    </div>
                    <div class="auth-border auth-surface overflow-hidden rounded-[32px] border border-[#2A2A2A] bg-[#111111]">
                        <div class="hero-photo relative h-56 sm:h-64 lg:h-72" style="--hero-image: url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1600&q=80');"></div>
                    </div>
                </div>
            </section>
                ...
                <div class="w-full max-w-[520px]">
                    <div class="auth-card soft-shadow overflow-hidden rounded-[32px] border border-[#2A2A2A] bg-[#171717]">
                        <div class="auth-cardhead border-b border-[#2A2A2A] bg-[#F7931E] px-6 py-5 text-center text-[#111111]">
                            <h2 class="text-3xl font-semibold tracking-normal">Selamat Datang</h2>
                            <p class="mt-2 text-sm leading-6">Masuk untuk melanjutkan ke Freelancr</p>
                        </div>

                        <form id="login-form" class="space-y-5 p-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <div class="auth-input input-shell flex h-14 items-center gap-3 rounded-2xl border border-[#2A2A2A] bg-[#111111] px-4">
                                    ...
                                    <input id="password" name="password" type="password" autocomplete="current-password" required class="auth-text h-full flex-1 bg-transparent text-base font-medium text-[#F5F5F4] outline-none placeholder:text-[#94A3B8]" placeholder="••••••••">
                                </div>
                            </div>
                            ...
                            <p class="auth-muted pt-2 text-center text-sm text-[#E5E7EB]">
                                Belum punya akun?
                                <a href="{{ route('register') }}" class="auth-link font-semibold text-[#F05A28] underline decoration-[#F7931E] underline-offset-4">Daftar di sini</a>
                            </p>
                        </form>
                    </div>
                </div>
